...
export class ClientHandler {
  ...
  async showCoffeeShops(ctx: BotContext): Promise<void> {
    ...
    const keyboard: TelegramBot.InlineKeyboardButton[][] = [
      [{ text: '🗺️ Показать на карте', url: 'https://maps.yandex.ru' }],
      [{ text: '◀️ Главная', callback_data: 'client_main_menu' }]
    ];
  ...
  async showAboutProgram(ctx: BotContext): Promise<void> {
    const aboutMessage = 
      ...
      `• Обменивайте баллы на скидки\n` +
      `• Накапливайте баллы без срока истечения\n\n` +
      `🎁 **Специальные бонусы:**\n` +
      `• 100 баллов в день рождения\n` +
      `• Двойные баллы в дни акций\n` +
      `• Приветственный бонус при регистрации\n` +
      `• Бонусы за приведенных друзей\n\n` +
      `🏆 **Статусы клиентов:**\n` +
      `• 🥉 Новичок: 0-10 посещений\n` +
      `• 🥈 Друг: 11-50 посещений\n` +
      `• 🥇 VIP: 50+ посещений\n\n` +
      `❓ **Вопросы?**\n` +
      `Обращайтесь к нашим бариста или пишите в поддержку!`;
